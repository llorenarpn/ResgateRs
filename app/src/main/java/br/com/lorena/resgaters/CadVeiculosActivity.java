...
public class CadVeiculosActivity extends AppCompatActivity {
        ...
        buttonRegisterVehicle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (vehicleType.isEmpty() || vehicleModel.isEmpty() || vehicleYear.isEmpty() ||
                    ...
                    Toast.makeText(CadVeiculosActivity.this, "Por favor, preencha todos os campos", Toast.LENGTH_SHORT).show();
                } else {
                    // Aqui você pode adicionar a lógica para salvar o veículo no backend
                    Toast.makeText(CadVeiculosActivity.this, "Veículo registrado com sucesso", Toast.LENGTH_SHORT).show();
